#!/bin/bash
mkdir /tmp/klassy
sudo apt install cmake build-essential libkf5config-dev libkdecorations2-dev libqt5x11extras5-dev qtdeclarative5-dev extra-cmake-modules libkf5guiaddons-dev libkf5configwidgets-dev libkf5windowsystem-dev libkf5coreaddons-dev libkf5iconthemes-dev gettext qt3d5-dev -y
...
tar -xvf /usr/lib/plasma-beautifier-qt/data/klassy.tar.xz -C /tmp/klassy
mkdir -p /tmp/klassy/klassy/build
cd /tmp/klassy/klassy/build && cmake .. && make -j4 && sudo make install
